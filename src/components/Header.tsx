    ...
    <header className="max-w-[1420px] mx-auto pb-[130px] flex flex-col lg:pl-[240px] py-[50px] space-x-1  lg:flex-row relative items-center [&_*]:text-white w-full">
      <div className="flex w-[80vw] lg:w-[70vw]">
        <div className="flex flex-col justify-center">
          ...
          <div className="mt-8 flex justify-center lg:justify-start items-center mb-[190px] lg:mb-0">
            <Socials />
          </div>
        </div>
      </div>
      <div className="absolute right-[10px] top-[270px] lg:right-[170px] lg:top-[40px] ">
        <Image
          alt="rocket ship"
          className="relative"
